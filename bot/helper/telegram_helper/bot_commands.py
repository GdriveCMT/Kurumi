...
class _BotCommands:
    def __init__(self):
        ...
        self.MirrorCommand = [f'yg{CMD_SUFFIX}', f'y{CMD_SUFFIX}']
        self.QbMirrorCommand = [f'ygqb{CMD_SUFFIX}', f'pqb{CMD_SUFFIX}']
        self.YtdlCommand = [
            f'ytdl{CMD_SUFFIX}', f'ygy{CMD_SUFFIX}', f'pwatch{CMD_SUFFIX}', f'pw{CMD_SUFFIX}']
        self.LeechCommand = [f'ygleech{CMD_SUFFIX}', f'pl{CMD_SUFFIX}']
        self.QbLeechCommand = [f'ygqbl{CMD_SUFFIX}', f'pqbl{CMD_SUFFIX}']
        self.YtdlLeechCommand = [
            f'ytdlleech{CMD_SUFFIX}', f'ygyl{CMD_SUFFIX}', f'ygwatchleech{CMD_SUFFIX}', f'pwl{CMD_SUFFIX}']
        self.CloneCommand = [f'ygclone{CMD_SUFFIX}', f'pcl{CMD_SUFFIX}']
        ...
        self.SpeedCommand = [f'ygspeedtest{CMD_SUFFIX}', f'sp{CMD_SUFFIX}']
